...
import {
  LogOut, Package, Settings, Users, Plug, Home, Palette, FileText, Boxes, ClipboardList,
} from "lucide-react";
            ...
            <nav className="flex items-center gap-0.5 text-sm">
              ...
              {user && (
                <>
                  ...
                  <NavLink to="/inventory" icon={<Boxes className="h-4 w-4" />}>
                    Inventory
                  </NavLink>
                  <NavLink to="/purchase-orders" icon={<ClipboardList className="h-4 w-4" />}>
                    Purchase orders
                  </NavLink>
                  <NavLink to="/integrations" icon={<Plug className="h-4 w-4" />}>
